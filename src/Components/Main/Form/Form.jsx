...
const NewTransactionForm = () => {
    ...
    return (
        <Grid>
            ...
            <Grid item xs={6}>
                <FormControl fullWidth>
                    <InputLabel1>Category</InputLabel1>
                    <Select value={formatDate.category} onChange={(e) => setFormData({...formData, category: e.target.value})}>
            ...
            <Grid>
                <TextField fullWidth label="Date" type="date" value={formData.date} onChangeCapture={(e) => setFormData({...formData, date: formatDate(e.target.value)})} />
            </Grid>
